                        ...
                        <div class="flex justify-between items-center flex-1 p-4">
                            <div>
                                ...
                                <p class="text-xs text-gray-500">
                                    <span class="text-md font-bold text-black dark:text-white">{{ followerCount
                                        }}</span>
                                    followers
                                </p>
                            </div>
            ...
            <div class="">
                <TabGroup>
                    <div class="bg-white dark:bg-black overflow-auto scrollbar-hide">
                        <TabList
                            class="flex w-[130vw] overflow-x-auto m-auto md:max-w-4xl dark:bg-black dark:text-white">
                    ...
                    <TabPanels class="md:mt-2 col-span-3 md:col-span-2 max-w-4xl m-auto">
                        <TabPanel>
                            <template v-if="posts">
                                <div class="grid grid-cols-5 md:gap-x-3">
                                    <!-- button for post constent -->
                                    <BulletPost v-if="user.name == authUser.name" />

                                    <div class="col-span-5 md:col-span-3">
                                        <CreatePost v-if="user.name == authUser.name" />
                                    ...
                                    <div class="hidden md:inline-block col-span-5 md:col-span-2">
                                        ...
                                        -0">
                                            <div
                                                class="bg-white dark:text-white dark:bg-zinc-950 p-3 rounded-2xl shadow">
