...
<template>
    <div
        ...
        class="py-3 px-3 border-y-[0.5px] md:border border-gray-200 dark:border-zinc-700 md:dark:border-zinc-800 md:dark:bg-zinc-950 text-gray-500 md:rounded-full w-full flex items-center cursor-pointer transition-all gap-3 bg-white dark:bg-black hover:border-blue-500 dark:hover:border-blue-500 mb-1 md:mb-1.5"
    >
        <img
