...
<template>
    <div
        class="bg-white md:border shadow dark:bg-black md:dark:bg-zinc-950 dark:border-zinc-900 md:dark:border-none md:border-slate-200 dark:text-gray-100 md:rounded-2xl p-4 md:p-4 md:pb-1.5 border-t-[0.5px] border-slate-100 md:mb-3 hover:bg-slate-50 dark:hover:bg-zinc-950 md:hover:bg-white md:dark:hover:bg-black overflow-x-hidden">
